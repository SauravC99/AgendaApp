...
public class ClassDatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String createTableStatement = "CREATE TABLE " + CLASSES_TABLE + " (" + COLUMN_CLASS_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " + COLUMN_CLASS_START_TIME + " TEXT, " + COLUMN_CLASS_END_TIME + " TEXT, " + COLUMN_CLASS_NAME + " TEXT)";
    ...
    public boolean addOne(ClassModel addClassModel) {
        ...
        long insert = db.insert(CLASSES_TABLE, null, cv);
        if (insert == -1) {
            return false;
        }
        else {
    ...
    public List<ClassModel> getAllClasses() {
        ...
        String queryString = "SELECT * FROM " + CLASSES_TABLE;
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                ClassModel newClass = new ClassModel(id, start, end, name);
